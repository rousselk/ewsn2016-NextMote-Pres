...
\addtobeamertemplate{navigation symbols}{}{%
    ...
    \hspace{1.5em}%
    \insertframenumber~/ 18%\inserttotalframenumber
}
...
\end{enumerate}
$\rightarrow$ this latter feature allows Cooja to embed emulators,
...
\begin{center}
\tblcaption{Observed TX buffer loading delay inaccuracies of MSPSim
